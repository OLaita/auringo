...
<body>
    <div id="app">
        <nav style="background-color:#272932;height: 15vh;" class="w-100 navbar navbar-expand-md shadow-sm">
            <div class="container">



                <div class="d-flex navbar-collapse align-items-center" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    <div class="">
                    <ul style="flex-direction:row"class=" navbar-nav mr-auto">
                   ...
                   <div class="collapse navbar-collapse " style="margin-top:30px;width:20px;height:20px">
                    ...
                    <ul style="flex-direction:row;justify-content:flex-end" class="navbar-nav ml-auto align-items-center">
                        ...
                        <li class="nav-item dropdown">
                            <a style="color:white"  id="navbarDropdown" class="nav-link dropdown-toggle justify-content-end" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            ...
                            <div style="position:absolute;width: 40vw; height:40vh; font-size:17px"class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <div style="width:50%; flex-wrap:wrap" class="d-flex">
                                <p style="color:#272932;margin-left:6%" >Mi cuenta</p>
                          ...
                          <i style="color:#272932;margin-right:10px" class="bi bi-gear-fill"></i>{{ __('Configuración') }}
                       </a>
                                ...
                                <a style="color:#272932;"class="dropdown-item" href="{{ route('logout') }}"
                                   onclick="event.preventDefault();
                                    ...
                                    <svg style="color:#272932;margin-right:10px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
