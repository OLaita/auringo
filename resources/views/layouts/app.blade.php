    ...
    <div id="app">
        ...
        <nav style="background-color:#272932;"class="navbar navbar-expand-lg navbar-dark">
          ...
          <li class="nav-item dropdown">
            <a style="color:white"  id="navbarDropdown" class="nav-link justify-content-end" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
              ...
              <div id="divdropdown" style="width:250px;position:absolute;font-size:17px;" class="dropdown-menu" aria-labelledby="dropdownMenu">
          ...
          <a class="dropdown-item" href="{{ route('editUser',['user'=>Auth::user()->username]) }}">

          <i style="margin-right:10px" class="bi bi-gear-fill"></i>{{ __('Configuración') }}
       </a>
       @if(Auth::user()->hasRole('admin'))
       <a class="dropdown-item" href="{{route('admin.panel')}}">
        <i style="margin-right:10px" class="bi bi-gear-fill"></i>{{ __('Panel de Administrador') }}
     </a>
     @endif
