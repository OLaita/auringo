@extends('layouts.app')
    ...
    <div class="container">
        <form id="proStore" method="POST" action="{{ route('pro.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-4">
                        <div class="mb-2 ">
                            ...
                            <div class="d-flex maxiwidth">
                                <input min="1" max="99999999" id="meta" name="meta" placeholder="3000" type="number" class=" form-control" aria-label="meta" aria-describedby="euros">
                        ...
                        <div class="mb-4">
                            ...
                            <input name="fechaFin" id="fechaFin" value="{{ now()->format('Y-m-d') }}" type="date" class="form-control maxiwidth">
                        </div>
